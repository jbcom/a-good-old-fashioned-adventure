...
- [ ] S8.23 Composition-driven route revision: use the new route-window rules to add another gameplay verb and stronger tile/prop variation to the weakest declared open stretches, with no rule exceptions unless the map states a clear travel or threshold purpose
