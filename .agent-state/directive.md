...
- [ ] S8.18 Shop-and-street depth pass: replace any remaining shallow shop/road reads with real storefront verbs, named NPC behavior loops, richer pixel props, and non-cross street geometry; prove it with docs, unit tests, headed phone/desktop evidence, and the public-control playthrough
