...
- [ ] S8.20 Route encounter variety pass: add a new authored micro-encounter beyond Hearthwake that is neither a shop nor a sign read, with a moving NPC or enemy behavior change, richer props in the player's depth band, and a later payoff line; prove with docs, unit/browser tests, phone/desktop screenshots, and the public-control playthrough
