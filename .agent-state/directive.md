...
- [ ] S8.16 Route reward loop: add a later route payoff for the stable/village preparation, such as a readable road marker, NPC response, or small encounter modifier beyond Hearthwake, with browser evidence and full playthrough coverage so early services echo outside the hub
