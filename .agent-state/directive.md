...
- [ ] S9.4 Rescue-route runtime slice: build the bottom-to-top core rescue map with knight start, princess top anchor, dragon guard, compact mobile HUD currencies, a two-to-five-minute phone-session route-length budget, and playthrough coverage
