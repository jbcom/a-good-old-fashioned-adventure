...
- [ ] S8.17 Oldwood visual-story density: add another authored road-life scene or micro-encounter on the mandatory route with bespoke pixel props, at least one named voice or moving NPC, and both desktop/phone evidence so the journey reads as inhabited rather than a sequence of corridors
