...
4. Citizens → named NPCs — COMPLETE (14 bodies, 21 characters, cross-map reuse).
5. Locked-class creative unlocks — COMPLETE (Spellsinger in red, Veilwalker hooded, Rogue content-ready). REMAINING: fx-image phase-out (Electric Lemon slash/staff/elemental strips into the projectile + burst pipeline), guard swordsman/archer ambience, outlaw random-encounter tier, Kenney interior/city slices, princess portrait pass.
